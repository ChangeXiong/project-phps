          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../sub_score/select_core_room1.php" target="frame" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>ຄະແນນປະຈຳວິຊາຊັ້ນມໍ 1</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../sub_score/select_score_room2.php" target="frame" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>ຄະແນນປະຈຳວິຊາຊັ້ັນມໍ 2</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../sub_score/select_core_room3.php" target="frame" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>ຄະແນນປະຈຳວິຊາຊັ້ນມໍ 3</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../sub_score/select_score_room4.php" target="frame" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>ຄະແນນປະຈຳວິຊາຊັ້ນມໍ 4</p>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <ul class="nav nav-treeview">
                <li class="nav-item">
                <a href="../checkname1/select_check_m1_1.php" target="frame" class="nav-link">
                    <p>ໝາຍຂາດ ຫ້ອງມ1/1</p>
                  </a>
                </li>
                
                <li class="nav-item">
                <a href="../checkname1/select_check_m1_2.php" target="frame" class="nav-link">
                      <p>ໝາຍຂາດ ຫ້ອງມ1/2</p>
                    </a>
                </li>
                <li class="nav-item">
                <a href="../checkname1/select_check_m1_3.php" target="frame" class="nav-link">
                      <p>ໝາຍຂາດ ຫ້ອງມ1/3</p>
                    </a>
                </li>
                <li class="nav-item">
                <a href="../checkname1/select_check_m1_4.php" target="frame" class="nav-link">
                      <p>ໝາຍຂາດ ຫ້ອງມ1/4</p>
                    </a>
                </li>
                <li class="nav-item">
                <a href="../checkname1/select_check_m1_5.php"target="frame" class="nav-link">
                     
                      <p>ໝາຍຂາດ ຫ້ອງມ1/5</p>
                    </a>
                </li>
                <li class="nav-item">
                <a href="../checkname1/select_check_m1_6.php" target="frame" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                <li class="nav-item">
                <a href="../checkname2/select_check_m2_1.php" target="frame" class="nav-link">
                    <p>ໝາຍຂາດ ຫ້ອງ2/1</p>
                  </a>
                </li>
                <li class="nav-item">
                <a href="../checkname2/select_check_m2_2.php" target="frame" class="nav-link">
                      <p>ໝາຍຂາດ ຫ້ອງມ2/2</p>
                    </a>
                </li>
                <li class="nav-item">
                <a href="../checkname2/select_check_m2_3.php" target="frame" class="nav-link">
                      <p>ໝາຍຂາດ ຫ້ອງມ2/3</p>
                    </a>
                </li>
                <li class="nav-item">
                <a href="../checkname2/select_check_m2_4.php" target="frame" class="nav-link">
                      <p>ໝາຍຂາດ ຫ້ອງມ2/4</p>
                    </a>
                </li>
              </ul>
