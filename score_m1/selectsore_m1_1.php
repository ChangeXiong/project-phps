...
$sql = mysqli_query($connect,"select a.inroom_id,a.y_study,b.dents_id,b.fname,b.lname,c.core_id,c.month_score,c.laguage,c.literature,c.mathermatics,c.it,c.fnaural,
                                ...
                                d.b_id,d.b_name,
                                e.r_id,e.r_name from set_st_room as a,student_biography as b,scores as c,b_class as d,r_class as e where a.dents_id=b.dents_id and a.inroom_id=c.inroom_id and a.b_id=d.b_id and a.r_id=e.r_id and e.r_name='ມ1/1' ");
?>
 <script>
        $(function(){
            $(".data").change(function(){
                var data = $(".data").val();
                $.post("sreach_scorem1.php",{
                    data : data
                },
                function(output){
                    $(".show").html(output);
...
<body>
    <div class="container py-2">
        <!-- <div class="row">
            ...
            <div class="col text-right d-flex justify-content-end"id="show_by">
                    ...
                    <div class="card-body">
            <div class="card-title text-center">ຄະແນນປະຈຳເດືອນ ຫ້ອງ1/1 </div>
                <div class="show">
                ...
                <div class="btn-group" role="group">
                    ...
                    <li><a class="dropdown-item" href="update_room.php?inroom_id=<?php echo $score['core_id'];?>"><button class="form-control bg-info">ແກ້ໄຂ</button></a></li>
