...
d.b_id,d.b_name,
e.r_id,e.r_name from set_st_room as a,student_biography as b,scores as c,b_class as d,r_class as e where a.dents_id=b.dents_id and a.inroom_id=c.inroom_id and a.b_id=d.b_id and a.r_id=e.r_id and e.r_name='ມ2/4' ");
?>
 <script>
        $(function(){
            $(".data").change(function(){
                var data = $(".data").val();
                $.post("sreach_scorem24.php",{
                    data : data
                },
                function(output){
                    $(".show").html(output);
        ...
        <!-- <div class="row">
            ...
            <div class="col-md-10"> -->
                ...
                <div class="col-md-3 text-right">
                    ...
                    <div class="card-body">
            <div class="card-title text-center">ຄະແນນປະຈຳເດືອນ ຫ້ອງ2/4 </div>
                <div class="show">
