...
?>
 <script>
        ...
        $(function(){
            $(".sore").keyup(function(){
                var fname = $(".sore").val();
                var sore_9 = $("#sore_2").val();
                var sore_10 = $("#sore_3").val();
                var sore_11 = $("#sore_4").val();
                $.post("get_aver.php",{
                    sore_9 : sore_9,
                    sore_10 : sore_10,
                    sore_11 : sore_11,
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="form-group mb-2">
                            <div class="row">
                                ...
                                <input type="hidden" name="" id="sore_2" value="<?php echo $select_show['sore_2'];?>">
                                <input type="hidden" name="" id="sore_3" value="<?php echo $select_show['sore_3'];?>">
                                <input type="hidden" name="" id="sore_4" value="<?php echo $select_show['sore_4'];?>">
                                    <div class="input-group">
                                    <div class="input-group-text text-success"><i class="fas fa-user"></i></div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name=""class="form-control aver_2" id="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-2">
