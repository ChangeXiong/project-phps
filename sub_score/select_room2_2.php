...
sub_scores as d,
b_class as e,
r_class as f where a.dents_id=b.dents_id and b.b_id=e.b_id and b.r_id=f.r_id and d.inroom_id=b.inroom_id and d.sub_id=c.sub_id and f.r_name='ມ2/2' ");
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <div class="btn-group" role="group">
                                        <button id="btnGroupDrop1" type="button" class="bg-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">ເລືອກຂໍ້ມູນ</button>
