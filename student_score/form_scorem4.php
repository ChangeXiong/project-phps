...
<script>
        ...
        $(function(){
        $(".laguage,.literature,.mathermatics,.it,.PH,.fnaural,.society,.population,.art,.mission,.english,.CH,.BI").keyup(function(){
            var a = parseInt($(".laguage").val());
            var b = parseInt($(".literature").val());
            var c = parseInt($(".mathermatics").val());
            var d = parseInt($(".it").val());
            var e = parseInt($(".PH").val());
            ...
            var tt = parseInt($(".CH").val());
            var ttt = parseInt($(".BI").val());
            var totals = parseFloat(a + b + c + d + e + f + g + j + k + t + tt + ttt) || 0;
            $(".amount").val(totals);
        });
    });
    $(function(){
        ...
        <div class="container-fluid">
            <div class="shadow rounded p-5 bg-body h-100">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <h3 class="pb-4"align="center">[ ຟອມບັນທຶກຄະແນນເດືອນສະເພາະຊັ້ນມໍ4 ]</h3>     
                        <div class="show">
                        ...
                        <form action="">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name=""class="form-control b_id" id="">
                                            ...
                                            $smp = mysqli_query($connect,"select b_id,b_name from b_class where b_name='ຊັ້ນມ4'");
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label for="">ຟີຊີກສາດ</label>
                                        <div class="input-group">
                                        <div class="input-group-text text-success"><i class="fas fa-plus"></i></div>
                                        <input type="text" name=""class="form-control PH" id=""placeholder="ປ້ອນຄະແນນ..!">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="">ເຄມີສາດ</label>
                                        <div class="input-group">
                                        <div class="input-group-text text-success"><i class="fas fa-plus"></i></div>
                                        <input type="text" name=""class="form-control CH" id=""placeholder="ປ້ອນຄະແນນ..!">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label for="">ຊີວະສາດ</label>
                                        <div class="input-group">
                                        <div class="input-group-text text-success"><i class="fas fa-plus"></i></div>
                                        <input type="text" name="lname" class="form-control BI" id="" placeholder="ປ້ອນຄະແນນ..!">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
