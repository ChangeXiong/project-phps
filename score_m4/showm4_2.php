...
$sql = mysqli_query($connect,"select a.inroom_id,a.y_study,b.dents_id,b.fname,b.lname,c.core_id,c.month_score,c.laguage,c.literature,c.mathermatics,c.it,c.PH,c.CH,c.BI,
c.society,c.population,c.art,c.mission,c.english,c.amount,c.average,
d.b_id,d.b_name,
e.r_id,e.r_name from set_st_room as a,student_biography as b,scores as c,b_class as d,r_class as e where a.dents_id=b.dents_id and a.inroom_id=c.inroom_id and a.b_id=d.b_id and a.r_id=e.r_id and e.r_name='ມ4/2' ");
?>
 <script>
        $(function(){
            $(".data").change(function(){
                var data = $(".data").val();
                $.post("sreach_score42.php",{
                    data : data
                },
                function(output){
                    $(".show").html(output);
   ...
   $core_id = $_GET['inroom_id'];
    ...
    if($msql){
        ...
        Swal.fire({
            position: 'top',
            icon: 'success',
            title: 'ແກ້ໄຂຂໍ້ມູນສຳເລັດແລ້ວຫ..',
            showConfirmButton: false,
            timer: 2500,
        })
        window.setTimeout(function(){
            location='showm4_1.php';
        },1500);
        </script>";
}else{
    echo"<script>
        ...
        <!-- <div class="row">
            ...
            <div class="col-md-10"> -->
                ...
                <div class="col-md-3 text-right">
                    ...
                    <div class="card-body">
            <div class="card-title text-center">ຄະແນນປະຈຳເດືອນ ຫ້ອງ4/1 </div>
                <div class="show">
                        <table id="example" class="table table-bordered table-striped">
                                ...
                                <tr>
                                   ...
                                   <th class="rotate"rowspan="4">ຊື່ ແລະ ນາມສະກຸນ</th>
                                    ...
                                    <th class="rotate"rowspan="4"><div>ປະຫ້ວດສາດ<div></th>
                                    ...
                                    <th class="rotate"rowspan="4"><div>ຟີຊີກສາດ</div></th>
                                    <th class="rotate"rowspan="4"><div>ເຄມີສາດ</div></th>
                                    <th class="rotate"rowspan="4"><div>ຊີວະສາດ</div></th>
                                    <th>ລວມ</th>
                                    <th>ສະເລ່ຍ</th>
                                    <th>ຂໍ້ມູນອືນ</th>
                                </tr> 
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $score['PH'];?></td>
                                    <td><?php echo $score['CH'];?></td>
                                    <td><?php echo $score['BI'];?></td>
