...
$mysql = mysqli_query($connect,"select a.dents_id,a.fname,a.lname,b.inroom_id,b.y_study,c.check_id,c.subject,c.hour,c.rdate,c.rtime,c.remark,d.b_name,e.r_name from student_biography as a,set_st_room as b,check_name as c,b_class as d,r_class as e where a.dents_id=b.dents_id and b.inroom_id=c.inroom_id and d.b_id=e.b_id and  r_name='ມ2/4'and b_name='ຊັ້ນມ2'");
?>
<body>
