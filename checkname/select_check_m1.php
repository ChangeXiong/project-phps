...
$mysql = mysqli_query($connect,"select a.dents_id,a.fname,a.lname,b.inroom_id,b.y_study,c.check_id,c.chk_moth,c.subject,c.hour,c.rdate,c.rtime,c.remark,d.b_name,e.r_name from student_biography as a,set_st_room as b,check_name as c,b_class as d,r_class as e where a.dents_id=b.dents_id and b.inroom_id=c.inroom_id and b.b_id=d.b_id and b.r_id=e.r_id and b_name='ຊັ້ນມ1'");
?>
<script>
        $(function(){
